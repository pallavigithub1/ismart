    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">        
                <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Communication Letter Reports</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href='<?php echo base_url("Dashboard")?>'>Home</a></li>
                    <li class="breadcrumb-item active">Communication Letter Reports</li>
                    </ol>
                </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        ...
        <div class="general-booking ml-4 mr-4">
            ...
            <h4>Puduvattu Communication Report</h4><br/>
...
<script>
        ...
        $('#date').submit(function(e){
            ...
            $.ajax({
                ...
                type : 'post',
                url  : '<?php echo site_url("Communication/date_between_items") ?>',
                data   : formdata,
                contentType: false,
                processData: false,
                ...
                {  
                    ...
                    datatype: "local",
                        ...
                        colNames:['id','Main Seva','Seva Inclues','Amount','Payment Mode','Payment Date','Seva Date','Created By','Communication Letter'],
                        
                        colModel:[
                            {name:'id',index:'id',hidden:true, width:100, editable:false, key: true, searchoptions: {sopt: ["eq"]}},
                            {name:'main_seva',index:'main_seva', width:150, editable:false, searchoptions: {sopt: ["eq"]}},
                            {name:'seva_include',index:'seva_include', width:150, editable:false, searchoptions: {sopt: ["eq"]}},
                            {name:'seva_price',index:'seva_price', width:100, editable:false, searchoptions: {sopt: ["eq"]}},
                            {name:'payment_mode',index:'payment_mode', width:150, editable:false, searchoptions: {sopt: ["eq"]}},
                            {name:'payment_date',index:'payment_date', width:150, editable:false, searchoptions: {sopt: ["eq"]}},
                            {name:'seva_date',index:'seva_date', width:150, editable:false, searchoptions: {sopt: ["eq"]}},
                            {name:'created_by',index:'created_by', width:150, editable:false, searchoptions: {sopt: ["eq"]}},       
                            {name:'',index:'',search:false, align:'center',
                                width:150, editable:false,formatter: function (cellvalue, options, rowObject) {
                                var retVal = "";
                                var retVal = '<a data-toggle="tooltip" title="Print" class="" href="javascript:void(0);"><span class="fa fa-print" onclick="generate($(this))"  style="color:blue;"></span></a>';
                                return retVal;           
                                }},
                            ],
                        rowNum:20,
                        ...
                        sortorder:"desc", 
                        shrinkToFit: true,
                        caption:"Puduvattu Communication Report"
...
function generate(rowId){
    ...
    myWindow = window.open('<?php echo site_url("Communication/print")?>?id='+id+'');
}
</script>
